...
sudo -u ehallmark1122 bash -c '    java -cp target/classes:"target/dependency/*" -Xms160000m -Xmx160000m -Dcom.sun.management.jmxremote.port=4567 -Dcom.sun.management.jmxremote.rmi.port=4567 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Djava.rmi.server.hostname=127.0.0.1 models.similarity_models.UpdateSimilarityModels'

# reingest computable attributes
sudo -u ehallmark1122 bash -c '    java -cp target/classes:"target/dependency/*" -Xms80000m -Xmx80000m -Dcom.sun.management.jmxremote.port=4567 -Dcom.sun.management.jmxremote.rmi.port=4567 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Djava.rmi.server.hostname=127.0.0.1 seeding.ai_db_updater.UpdateAll 11 '
