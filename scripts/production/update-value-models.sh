...
cd /home/ehallmark1122/machine_learning_cloud
sleep 90s
sudo -u ehallmark1122 bash -c '    java -cp target/classes:"target/dependency/*" -Xms10000m -Xmx10000m -Dcom.sun.management.jmxremote.port=4567 -Dcom.sun.management.jmxremote.rmi.port=4567 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Djava.rmi.server.hostname=127.0.0.1 models.value_models.UpdateValueModels'
