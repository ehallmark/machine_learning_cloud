...
sudo -u ehallmark1122 bash -c '    java -cp target/classes:"target/dependency/*" -Xms40000m -Xmx40000m -Dcom.sun.management.jmxremote.port=4567 -Dcom.sun.management.jmxremote.rmi.port=4567 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Djava.rmi.server.hostname=127.0.0.1 models.dl4j_neural_nets.vectorization.ParagraphVectorModel &'
