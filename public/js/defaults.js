$(document).ready(function() {
    ...
    $('.miniTip2').miniTip({
        ...
        event: 'click',
        content: "<p>Supports most functionality available in the Acclaim Expert Search form. NEAR and ADJ are currently not supported; however, proximity searching (\"word1 word2\"~N) is supported.</p><div>Supported Fields: </div>"+$('#acclaim-supported-fields').html()
    });
