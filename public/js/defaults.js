$(document).ready(function() {
    ...
    $('.miniTip2').miniTip({
        ...
        event: 'click',
        content: "<p>Supports most functionality available in the Acclaim Expert Search form. NEAR and ADJ are currently not supported; however, proximity searching</p><p>(\"word1 word2\"~N)</p><p> is supported.</p><p>Supported Fields: </p>"+$('#acclaim-supported-fields').html()
    });
