...
public class Database {
	...
	private static final String patentVectorStatement = "SELECT pub_doc_number, abstract, substring(description FROM 1 FOR ?) patent_grant WHERE pub_date >= ? AND (abstract IS NOT NULL AND description IS NOT NULL)";
