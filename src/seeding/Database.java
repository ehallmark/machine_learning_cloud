...
public class Database {
	...
	private static final String patentVectorStatement = "SELECT pub_doc_number, abstract, REGEXP_REPLACE(description, 'fig.', 'fig', 'g') FROM patent_grant WHERE pub_date >= ? AND (invention_title IS NOT NULL AND abstract IS NOT NULL AND description IS NOT NULL)";
