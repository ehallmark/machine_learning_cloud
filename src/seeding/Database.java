...
public class Database {
	...
	private static final String patentVectorStatement = "SELECT pub_doc_number, abstract, regexp_replace(substring(description FROM 1 FOR ?), 'fig\\.', 'fig', 'g') FROM patent_grant WHERE pub_date >= ? AND (abstract IS NOT NULL AND description IS NOT NULL)";
