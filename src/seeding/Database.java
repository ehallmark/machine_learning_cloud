...
public class Database {
	...
	private static final String claimsFromPatent = "SELECT claim_text FROM patent_grant_claim WHERE uid > 75000000 AND claim_text IS NOT NULL and parent_claim_id is null";
