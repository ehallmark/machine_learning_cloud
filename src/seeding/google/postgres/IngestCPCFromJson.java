...
public class IngestCPCFromJson extends IngestPatentsFromJson {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        final String sql = "insert into big_query_patent_to_cpc (publication_number_full,family_id,code,inventive,tree) values "+valueStr+" on conflict (publication_number_full) do update set (family_id,code,inventive,tree) = "+conflictStr;
