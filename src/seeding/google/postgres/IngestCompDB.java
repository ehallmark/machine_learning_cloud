...
public class IngestCompDB {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PreparedStatement insert = seedConn.prepareStatement("insert into big_query_compdb_deals (deal_id,recorded_date,technology,doc_number,inactive,acquisition,reel_frame,buyer,seller) values (?,?,?,?,?,?,?) on conflict (deal_id) do update set (technology,recorded_date,doc_number,inactive,acquisition,reel_frame,buyer,seller)=(?,?,?,?,?,?)");
