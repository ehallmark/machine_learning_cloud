...
create table patents_global_merged (
    ...
    --counterpart_application_number_formatted_with_country text[],
    --counterpart_application_number_formatted text[],
...
(
    select   -- monster query
        ...
        --coalesce(counter.counterpart_publication_number_full, ARRAY[p.publication_number_full]),
        --coalesce(counter.counterpart_publication_number_with_country, ARRAY[p.country_code||p.publication_number]),
        --coalesce(counter.counterpart_publication_number, ARRAY[p.publication_number]),
        --coalesce(counter.counterpart_application_number_formatted_with_country, ARRAY[p.country_code||p.application_number_formatted]),
        --coalesce(counter.counterpart_application_number_formatted, ARRAY[p.application_number_formatted]),
        ...
        -- cpc
        cpc_tree.code, --coalesce(cpc_tree.code,cpc_tree_by_fam.code),
        ...
        -- wipo tech
        coalesce(wipo.wipo_technology,case when wipo_pred.wipo_technology is null then null else ARRAY[wipo_pred.wipo_technology] end),
        -- gtt tech
        --tech.technology,
        --tech.technology2,
        -- ke.keywords,
