...
create table big_query_embedding_by_pub2 (
    publication_number_full varchar(32) primary key,
    enc float[] not null
);

insert into big_query_embedding_by_pub2 (publication_number_full,enc) (
...
alter table big_query_embedding_by_pub2 rename to big_query_embedding_by_pub;
