...
public class IngestCourtData {
    ...
    private static void ingestData()throws Exception {
        ...
        Consumer<Map<String,Object>> ingest = map -> {
            ...
            int infringedIdx = text.indexOf("infring");
            boolean patentInfringementFlag = (infringedIdx>0&&(text.contains("patent")||text.contains("trademark")||text.contains("intellectual propert")||text.contains("copyright")))||text.contains("copyright infringement")||text.contains("trademark infringement")||text.contains("direct infringement")||text.contains("doctrine of equivalents")||text.contains("induced infringement")||text.contains("doctrine of complete coverage")||text.contains("doctrine of compromise")||text.contains("doctrine of estoppel")||text.contains("doctrine of superfluit")||text.contains("literal infringement")||text.contains("willful infringement")|| text.contains("patent infringement")||text.contains("patent violation")||text.contains("intellectual propert");
