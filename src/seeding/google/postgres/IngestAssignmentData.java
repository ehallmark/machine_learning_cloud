...
public class IngestAssignmentData {
    ...
    private static void ingestData()throws Exception {
        ...
        final String assignmentDocumentId = "insert into big_query_assignment_documentid (reel_frame,publication_number,publication_kind,application_number_formatted,application_kind) values "+valueStrDocumentId+" on conflict do nothing";
