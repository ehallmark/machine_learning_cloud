...
public class IngestJsonHelper {
    ...
    private static Object handleValue(String k, Object v) {
        if(v!=null && v instanceof String) {
            ...
            if(k.endsWith("_date")||k.equals("date")||k.endsWith("Date")||k.contains("_date_")) {
                if(v.equals("0")) {
                    return null;
                } else {
        ...
        } else if(v!=null&& (k.endsWith("_date")||k.equals("date")||k.endsWith("Date")||k.contains("_date_")) && v instanceof Integer) {
            if(v.equals(0)) {
                return null;
            }
            return LocalDate.parse(v.toString(),DateTimeFormatter.BASIC_ISO_DATE).format(DateTimeFormatter.ISO_DATE);
