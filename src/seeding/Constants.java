...
public class Constants {
	...
	static {
		...
		ATTRIBUTE_DESCRIPTION_MAP.put(Attributes.CITED_CATEGORY, "category of the citation. Available categories: (CH2 = Chapter 2; SUP = Supplementary search report; ISR = International search report; SEA = Search report; APP = Applicant; EXA = Examiner; OPP = Opposition; 115 = article 115; PRS = Pre-grant pre-search; APL = Appealed; FOP = Filed opposition)");
		ATTRIBUTE_DESCRIPTION_MAP.put(Attributes.RCITE_CATEGORY, "category of the citation. Available categories: (CH2 = Chapter 2; SUP = Supplementary search report; ISR = International search report; SEA = Search report; APP = Applicant; EXA = Examiner; OPP = Opposition; 115 = article 115; PRS = Pre-grant pre-search; APL = Appealed; FOP = Filed opposition)");
		ATTRIBUTE_DESCRIPTION_MAP.put(Attributes.RCITE_TYPE, "type of the citation. Available types: (A = technological background; D = document cited in application; E = earlier patent document; 1 = document cited for other reasons; O = Non-written disclosure; P = Intermediate document; T = theory or principle; X = relevant if taken alone; Y = relevant if combined with other documents)");
		ATTRIBUTE_DESCRIPTION_MAP.put(Attributes.CITED_TYPE, "type of the citation. Available types: (A = technological background; D = document cited in application; E = earlier patent document; 1 = document cited for other reasons; O = Non-written disclosure; P = Intermediate document; T = theory or principle; X = relevant if taken alone; Y = relevant if combined with other documents)");
