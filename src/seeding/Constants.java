...
public class Constants {
	...
	public static final Map<String,String> ACCLAIM_IP_TO_ATTR_NAME_MAP = Stream.of(
			...
			Arrays.asList("FCITE", CITATIONS+"."+NAME),
			Arrays.asList("RCITE", BACKWARD_CITATION),
			Arrays.asList("FCITE_CT", CITATIONS+COUNT_SUFFIX),
			Arrays.asList("RCITE_CT", NUM_BACKWARD_CITATIONS),
