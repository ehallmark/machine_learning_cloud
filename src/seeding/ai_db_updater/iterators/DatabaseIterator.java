...
public class DatabaseIterator {
    ...
    protected List<EndFlag> endFlags = new ArrayList<>();
    ...
    protected void initAndAddFlagsAndEndFlags() {
        ...
        // application flags
        EndFlag documentFlag = new EndFlag("patent_grant") {
            @Override
            public void save() {
                try {
                    ...
                    synchronized (DatabaseIterator.class) {
    ...
    public void run() throws SQLException {
        ...
        String patentDBQuery = "select * from patentdb where pub_date between ? and ?";
