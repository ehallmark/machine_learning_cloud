...
public class PAIRHandler extends CustomHandler{
    ...
    public PAIRHandler() {
        ...
        applicationLeafFlags.add(new Flag("PatentNumber","grant_number","text",(str)->!str.equals("0")));
        ...
        applicationLeafFlags.add(new Flag("OSIEDUJGLISDJGLKJDSGL","assignee","text"));
