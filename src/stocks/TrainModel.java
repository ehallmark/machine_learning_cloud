...
public class TrainModel {
    ...
    public static void main(String[] args) throws Exception {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder(NNOptimizer.defaultNetworkConfig())
                ...
                .list()
                .layer(0, NNOptimizer.newDenseLayer(13, 50).build())
                .layer(1, NNOptimizer.newBatchNormLayer(50,50).build())
                .layer(2, NNOptimizer.newDenseLayer(50,50).build())
                .layer(3, NNOptimizer.newBatchNormLayer(50,50).build())
                .layer(4, NNOptimizer.newOutputLayer(50,1).activation(Activation.TANH).lossFunction(LossFunctions.LossFunction.MSE).build())
                .backprop(true)
                .pretrain(false)
                .build();
