...
public class WIPOTechnologyClassifier extends ClassificationAttr {
    ...
    private static List<Pair<String,Double>> wipoHelper(Collection<String> patents, int limit) {
        ...
        Item[] items = DataSearcher.searchForAssets(Arrays.asList(new WIPOTechnologyAttribute()), Arrays.asList(new AbstractIncludeFilter(new AssetNumberAttribute(), AbstractFilter.FilterType.Include, AbstractFilter.FieldType.Text, patents)), null, SortOrder.ASC, 10000, new HashMap<>());
