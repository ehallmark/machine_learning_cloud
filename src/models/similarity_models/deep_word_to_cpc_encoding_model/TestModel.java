...
public class TestModel {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String modelName = DeepWordToCPCPipelineManager.MODEL_NAME;
        ...
        DeepWordToCPCPipelineManager pipelineManager = new DeepWordToCPCPipelineManager(modelName, cpcEncodingPipelineManager);

        DeepWordToCPCEncodingNN model = new DeepWordToCPCEncodingNN(pipelineManager,modelName);
        model.loadBestModel();
