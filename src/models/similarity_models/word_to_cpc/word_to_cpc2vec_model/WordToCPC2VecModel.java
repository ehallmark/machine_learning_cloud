 ...
 */
public class WordToCPC2VecModel extends NeuralNetworkPredictionModel<INDArray> {
    public static final File BASE_DIR = new File(Constants.DATA_FOLDER+"word_to_cpc2vec_model_data");

    private AbstractWordToCPCPipelineManager pipelineManager;
    public WordToCPC2VecModel(AbstractWordToCPCPipelineManager pipelineManager, String modelName) {
        super(modelName);
