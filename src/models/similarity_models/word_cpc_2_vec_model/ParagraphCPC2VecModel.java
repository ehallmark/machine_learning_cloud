 ...
 */
public class ParagraphCPC2VecModel extends WordVectorPredictionModel<Map<String,INDArray>> {
    ...
    private ParagraphCPCVecPipelineManager pipelineManager;
    private final int vectorSize;
    public ParagraphCPC2VecModel(ParagraphCPCVecPipelineManager pipelineManager, String modelName, int vectorSize) {
    ...
    public void train(int nEpochs) {
        ...
        ParagraphCPCIterator iterator = pipelineManager.getDatasetManager().getTrainingIterator();
