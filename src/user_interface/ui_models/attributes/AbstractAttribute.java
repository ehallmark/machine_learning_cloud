...
public abstract class AbstractAttribute {
    ...
    public Tag getOptionsTag(Function<String,Boolean> userRoleFunction) { return div().with(div().withClass("attribute hide").attr("disabled","disabled").withId(getFullName())); }
