...
public class BigQueryServer extends SimilarPatentServer {
    ...
    static {
        ...
        { // Attributes
            ...
            humanAttrToJavaAttrMap.put("Cited Family ID", Attributes.RCITE_FAMILY_ID);
            humanAttrToJavaAttrMap.put("Cited Publication Number", Attributes.RCITE_PUBLICATION_NUMBER);
            humanAttrToJavaAttrMap.put("Cited Publication Number w/ Country", Attributes.RCITE_PUBLICATION_NUMBER_WITH_COUNTRY);
            humanAttrToJavaAttrMap.put("Cited Publication Number Full", Attributes.RCITE_PUBLICATION_NUMBER_FULL);
            humanAttrToJavaAttrMap.put("Cited Application Number", Attributes.RCITE_APPLICATION_NUMBER_FORMATTED);
            humanAttrToJavaAttrMap.put("Cited Application Number w/ Country", Attributes.RCITE_APPLICATION_NUMBER_FORMATTED_WITH_COUNTRY);
            ...
            humanAttrToJavaAttrMap.put("Number of Citations", Attributes.RCITATIONS_COUNT);
