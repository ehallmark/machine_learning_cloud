...
public class BigQueryServer extends SimilarPatentServer {
    ...
    static {
        ...
        { // Attributes
            ...
            humanAttrToJavaAttrMap.put("Include Assets", AbstractFilter.FilterType.AssetInclude.toString());
            humanAttrToJavaAttrMap.put("Exclude Assets", AbstractFilter.FilterType.AssetExclude.toString());
            ...
            humanAttrToJavaAttrMap.put("Forward Cite Publication Number", Attributes.RCITE_PUBLICATION_NUMBER);
            humanAttrToJavaAttrMap.put("Forward Cite Publication Number w/ Country", Attributes.RCITE_PUBLICATION_NUMBER_WITH_COUNTRY);
            humanAttrToJavaAttrMap.put("Forward Cite Publication Number Full", Attributes.RCITE_PUBLICATION_NUMBER_FULL);
            humanAttrToJavaAttrMap.put("Forward Cite Application Number", Attributes.RCITE_APPLICATION_NUMBER_FORMATTED);
            humanAttrToJavaAttrMap.put("Forward Cite Application Number w/ Country", Attributes.RCITE_APPLICATION_NUMBER_FORMATTED_WITH_COUNTRY);
            ...
            humanAttrToJavaAttrMap.put("Cited Family ID", Attributes.CITED_FAMILY_ID);
            humanAttrToJavaAttrMap.put("Cited Publication Number", Attributes.CITED_PUBLICATION_NUMBER);
            humanAttrToJavaAttrMap.put("Cited Publication Number w/ Country", Attributes.CITED_PUBLICATION_NUMBER_WITH_COUNTRY);
            humanAttrToJavaAttrMap.put("Cited Publication Number Full", Attributes.CITED_PUBLICATION_NUMBER_FULL);
            humanAttrToJavaAttrMap.put("Cited Application Number", Attributes.CITED_APPLICATION_NUMBER_FORMATTED);
            humanAttrToJavaAttrMap.put("Cited Application Number w/ Country", Attributes.CITED_APPLICATION_NUMBER_FORMATTED_WITH_COUNTRY);
            humanAttrToJavaAttrMap.put("Priority Claim Family ID", Attributes.CITED_FAMILY_ID);
