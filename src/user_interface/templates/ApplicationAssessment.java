 ...
 */
public class ApplicationAssessment extends FormTemplate {

    public ApplicationAssessment() {
        super(Constants.APPLICATION_ASSESSMENT, getParams(), FormTemplate.valueApplicationSmall(), Arrays.asList(SimilarPatentServer.PATENTS_TO_SEARCH_IN_FIELD,SimilarPatentServer.ASSIGNEES_TO_SEARCH_IN_FIELD));
    }
