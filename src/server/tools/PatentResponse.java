...
public class PatentResponse extends ServerResponse {
    ...
    private static Tag to_html_table(List<PatentList> patentLists, String query, boolean findDissimiar) {
        // List
        String similarName = findDissimiar ? "Dissimilar" : "Similar";
        return div().with(
                            ...
                            tbody().with(
                                    patentList.getPatents().stream().sorted(new Comparator<AbstractPatent>() {
                                        ...
                                        public int compare(AbstractPatent o1, AbstractPatent o2) {
                                            return !findDissimiar ? Double.compare(o1.getSimilarity(),o2.getSimilarity()) : Double.compare(o2.getSimilarity(),o1.getSimilarity());
                                        }
                                    }).map(patent->
