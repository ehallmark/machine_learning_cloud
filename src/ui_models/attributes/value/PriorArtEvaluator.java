...
public class PriorArtEvaluator extends ValueAttr {
    ...
    public PriorArtEvaluator() {
        super(ValueMapNormalizer.DistributionType.Uniform,"Prior Art Value");
    ...
    private static Map<String,Double> runModel(ParagraphVectors paragraphVectors){
        ...
        Map<LocalDate,Set<String>> groupedDateToPatentMap = DateHelper.groupMapByMonth(dateToPatentsMap);
