...
public class LeadDevelopmentSearch extends FormTemplate {
    ...
    private static Map<String,Object> getParams() {
        ...
        map.put(SimilarPatentServer.ATTRIBUTES_ARRAY_FIELD,Arrays.asList(Constants.NAME,Constants.ASSIGNEE,Constants.PORTFOLIO_SIZE,Constants.WIPO_TECHNOLOGY,Constants.TECHNOLOGY));
