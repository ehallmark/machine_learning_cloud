...
public class HDF4DatasetCreate {
    ...
    public static void main(String args[]) throws Exception {
        ...
        if (vgroup_id1 >= 0) 
            sds_id = HDFLibrary.SDcreate (sd_id, "2D 32-bit integer 20x10", HDFConstants.DFNT_INT32, 2, dims2D);
        ...
        if (vgroup_id1 >= 0) 
            sds_id = HDFLibrary.SDcreate (sd_id, "3D 8-bit unsigned integer 20x10x5", HDFConstants.DFNT_INT8, 3, dims3D);
